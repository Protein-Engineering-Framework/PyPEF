...
$pypef ml --show
#$pypef ml -e dca -l LS.fasl -t TS.fasl --regressor lasso --params ANEH_72.6.params --threads $threads  # programmed error due to no positive R2
#$pypef ml --show
#$pypef ml -e dca -l LS.fasl -t TS.fasl --regressor elasticnet --params ANEH_72.6.params --threads $threads  # programmed error due to no positive R2
#$pypef ml --show

$pypef ml --show

$pypef ml -e aaidx -m FAUJ880104 -f TS.fasl
$pypef ml -e onehot -m ONEHOTMODEL -f TS.fasl
$pypef ml -e dca -m DCAMLMODEL -f TS.fasl --params ANEH_72.6.params --threads $threads 
$pypef ml -e aaidx -m FAUJ880104 -f TS.fasl --label
$pypef ml -e onehot -m ONEHOTMODEL -f TS.fasl --label
$pypef ml -e dca -m DCAMLMODEL -f TS.fasl --label --params ANEH_72.6.params --threads $threads
$pypef ml -e aaidx -m FAUJ880104 -f TS.fasl --color --y_wt -1.5
$pypef ml -e onehot -m ONEHOTMODEL -f TS.fasl --color --y_wt -1.5
$pypef ml -e dca -m DCAMLMODEL -f TS.fasl --params ANEH_72.6.params --color --y_wt -1.5 --threads $threads
...
$pypef ml -e dca -m DCAMLMODEL -p 37_ANEH_variants_prediction_set.fasta --params ANEH_72.6.params --threads $threads
...
$pypef ml -e dca -m DCAMLMODEL --params ANEH_72.6.params --pmult --drecomb --trecomb --qarecomb --qirecomb --ddiverse --threads $threads
...
$pypef ml -e dca directevo -m DCAMLMODEL -w Sequence_WT_ANEH.fasta --y_wt -1.5 --negative --params ANEH_72.6.params
...
$pypef ml -e dca directevo -m DCAMLMODEL -w Sequence_WT_ANEH.fasta -y -1.5 --numiter 10 --numtraj 8 --negative --params ANEH_72.6.params
...
$pypef ml -e dca directevo -m DCAMLMODEL -i 37_ANEH_variants.csv -w Sequence_WT_ANEH.fasta -y -1.5 --temp 0.1 --usecsv --csvaa --negative --params ANEH_72.6.params
...
$pypef hybrid -m HYBRIDMODEL -t TS.fasl --params ANEH_72.6.params --threads $threads
$pypef hybrid -m HYBRIDMODEL -f TS.fasl --params ANEH_72.6.params --threads $threads
$pypef hybrid -m HYBRIDMODEL -f TS.fasl --params ANEH_72.6.params --label --threads $threads
...
$pypef hybrid -m HYBRIDMODEL -t TS.fasl --params uref100_avgfp_jhmmer_119_plmc_42.6.params --threads $threads
$pypef hybrid -m HYBRIDMODEL -f TS.fasl --params uref100_avgfp_jhmmer_119_plmc_42.6.params --threads $threads
$pypef hybrid -m HYBRIDMODEL -f TS.fasl --params uref100_avgfp_jhmmer_119_plmc_42.6.params --label --threads $threads
...
$pypef hybrid -m DCAMODEL -f TS.fasl --params uref100_avgfp_jhmmer_119_plmc_42.6.params --label --threads $threads
